    ...
    galleryItems: [
      {
        ...
        images: ['./assets/spatial/nanlao-spring/cover.jpg'],
        ...
        drawings: [
          ...
          './assets/spatial/nanlao-spring/drawing-2.jpg',
          './assets/spatial/nanlao-spring/drawing-3.jpg',
          './assets/spatial/nanlao-spring/drawing-4.jpg',
          './assets/spatial/nanlao-spring/drawing-5.jpg',
          './assets/spatial/nanlao-spring/drawing-6.png',
          './assets/spatial/nanlao-spring/drawing-7.jpg'
        ],
      },
      {
        id: 'sdna-shanghai',
        ...
        images: ['./assets/spatial/sdna-shanghai/cover.jpg'], 
        description: '基于 SDNA 空间句法与网络分析模型的上海城市路网整合度研究。',
        drawings: [
          './assets/spatial/sdna-shanghai/drawing-1.jpg',
          './assets/spatial/sdna-shanghai/drawing-2.jpg',
          './assets/spatial/sdna-shanghai/drawing-3.jpg',
      ...
      },
      {
        ...
        images: ['./assets/spatial/yishui/cover.jpg'],
        ...
        drawings: [
          ...
          './assets/spatial/yishui/drawing-3.jpg',
          './assets/spatial/yishui/drawing-4.jpg'
        ],
        processFiles: [
          './assets/spatial/yishui/process-1.jpg',
          './assets/spatial/yishui/process-2.jpg',
          './assets/spatial/yishui/process-3.jpg',
          './assets/spatial/yishui/process-4.jpg',
          './assets/spatial/yishui/process-5.jpg',
          './assets/spatial/yishui/process-6.jpg',
      ...
      },
      {
        ...
        images: ['./assets/spatial/ai-rendering/cover.jpg'],
        description: 'AI赋能渲染探索。',
        drawings: [
          './assets/spatial/ai-rendering/drawing-1.jpg',
          './assets/spatial/ai-rendering/drawing-2.jpg',
          './assets/spatial/ai-rendering/drawing-3.jpg',
      ...
      },
      {
        ...
        images: ['./assets/spatial/taiyuan-urban/cover.jpg'],
        description: '太原钟鼓楼片区更新城市设计。',
        drawings: [
          './assets/spatial/taiyuan-urban/drawing-1.jpg',
          './assets/spatial/taiyuan-urban/drawing-2.jpg',
          './assets/spatial/taiyuan-urban/drawing-3.jpg',
          './assets/spatial/taiyuan-urban/drawing-4.jpg',
          './assets/spatial/taiyuan-urban/drawing-5.jpg',
          './assets/spatial/taiyuan-urban/drawing-6.jpg'
        ],
      },
      {
        ...
        drawings: [
          ...
          './assets/spatial/residential-planning/drawing-2.jpg',
          './assets/spatial/residential-planning/drawing-3.jpg',
          './assets/spatial/residential-planning/drawing-4.jpg'
        ],
      },
      {
        id: 'public-building',
      ...
      },
      {
        ...
        drawings: [
          ...
          './assets/spatial/light-topology/drawing-2.jpg'
        ],
      }
    ]
  },
